...
<body style="background-image: url(images/7.jpg);background-size: cover;">
	...
	<div class="div3">
		<fieldset class="box4" style="top:0px;">
			...
			<div class="topnav" style="width:250px;top:20px;left:25px;">
				<a href="#home" class="active">Team Members</a>
				<div id="myLink3">
					<a href="#news">1</a>
				    <a href="#contact">2</a>
				    <a href="#about">3</a>
			...
			<div class="box6">
				<form action="" method="POST">
					<button class="sendemail" style="top:35px"name="email" type="" value="">Send Email</button>
				</form>
			</div>

		<fieldset class="box4" style="top:50px">
